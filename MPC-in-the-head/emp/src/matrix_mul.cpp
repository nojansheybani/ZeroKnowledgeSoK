// Based on https://github.com/emp-toolkit/emp-zk/blob/master/test/arith/matrix_mul.cpp
...
void test_circuit_zk(BoolIO<NetIO> *ios[threads], int party, int matrix_sz) {
	...
	auto mult_timeuse = time_from(start);
	...
	cout << "Time for MatMul: " << mult_timeuse << " us" <<  endl;
