# A Survey on Zero Knowledge Frameworks

This is a supplement to our [Survey on Zero-Knowledge Frameworks](). In this repo, we provide open-source environments for all of the frameworks we discuss in our survey, plus a few more.
...
- Add benchmarks for frameworks that are not in survey
